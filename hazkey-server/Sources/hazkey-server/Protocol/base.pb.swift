...
struct Hazkey_RequestEnvelope: Sendable {
  ...
  var getUserDictionary: Hazkey_Dictionary_GetUserDictionary {
    get {
      if case .getUserDictionary(let v)? = payload {return v}
      return Hazkey_Dictionary_GetUserDictionary()
    }
    set {payload = .getUserDictionary(newValue)}
  }

  var setUserDictionary: Hazkey_Dictionary_SetUserDictionary {
    get {
      if case .setUserDictionary(let v)? = payload {return v}
      return Hazkey_Dictionary_SetUserDictionary()
    }
  ...
  enum OneOf_Payload: Equatable, Sendable {
    ...
    case getUserDictionary(Hazkey_Dictionary_GetUserDictionary)
    case setUserDictionary(Hazkey_Dictionary_SetUserDictionary)
...
struct Hazkey_ResponseEnvelope: Sendable {
  ...
  var currentUserDictionary: Hazkey_Dictionary_CurrentUserDictionary {
    get {
      if case .currentUserDictionary(let v)? = payload {return v}
      return Hazkey_Dictionary_CurrentUserDictionary()
    }
    set {payload = .currentUserDictionary(newValue)}
  }
  ...
  enum OneOf_Payload: Equatable, Sendable {
    ...
    case currentUserDictionary(Hazkey_Dictionary_CurrentUserDictionary)
...
extension Hazkey_RequestEnvelope: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 105: try {
        var v: Hazkey_Dictionary_GetUserDictionary?
        var hadOneofValue = false
        if let current = self.payload {
          hadOneofValue = true
      ...
      case 106: try {
        var v: Hazkey_Dictionary_SetUserDictionary?
        var hadOneofValue = false
        if let current = self.payload {
          hadOneofValue = true
...
extension Hazkey_ResponseEnvelope: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    101: .standard(proto: "current_user_dictionary"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 101: try {
        var v: Hazkey_Dictionary_CurrentUserDictionary?
        var hadOneofValue = false
        if let current = self.payload {
          hadOneofValue = true
          if case .currentUserDictionary(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.payload = .currentUserDictionary(v)
        }
      }()
      default: break
      }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    case .currentUserDictionary?: try {
      guard case .currentUserDictionary(let v)? = self.payload else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 101)
    }()
    case nil: break
    }
